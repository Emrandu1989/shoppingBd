...
const Products = () => {
    ...
    const applyFilters = () => {
        ...
        if (sortOption === 'priceLowToHigh') {
            ...
            result = result.sort((a, b) => new Date(b.creationDate) - new Date(a.creationDate));
        }
        ...
        <div className="p-4 my-10">
            ...
            <div className="mb-4 md:px-[160px] flex flex-col flex-wrap space-y-4">
                <div className="flex">
                    <input
                        ...
                        className="w-full p-2 border border-gray-300 rounded-l-md shadow-sm"
                    />
                    <button
                ...
                <div className='flex justify-center'>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10 mb-4">
                        {filteredProducts.map(product => (
                            <div key={product._id} className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out">
                                <img
                                    src={product.image}
                                    alt={product.name}
            ...
            <div className="flex justify-center items-center space-x-4">
                <button
                    ...
                    className={`px-4 py-2 bg-orange-500 text-white rounded-md ${currentPage === 1 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-orange-600'} transition-colors duration-300`}
                >
                    Previous
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-2 bg-orange-500 text-white rounded-md ${currentPage === totalPages ? 'opacity-50 cursor-not-allowed' : 'hover:bg-orange-600'} transition-colors duration-300`}
                >
                    Next
                </button>
            </div>
